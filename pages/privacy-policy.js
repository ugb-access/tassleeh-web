		...
		<>
			<div class="container mx-auto my-4 px-10">
				...
				<main class="mt-3 font-normal md:font-medium text-base text-justify">
					...
					<div className="">
						<h2 className="text-[#17365d] heading-privacy text-2xl font-bold whitespace-nowrap">
							Interpretation and Definitions
						</h2>
					</div>
					<br />
					<h2 className="text-[#4f81bd] text-xl font-semibold">
						Interpretation
					</h2>
					<br />
					<p>
					...
					<br />
					<h2 className="text-[#4f81bd] text-xl font-semibold">Definitions</h2>
					<div className="mb-1">
					...
					<div className="mb-1">
						<span className="text-lg font-semibold">Application</span> refers to
						Job Locator, the software program provided by the Company.
					</div>
					<div className="mb-1">
						<span className="text-lg font-semibold">Company</span> (referred to
						as either "the Company", "We", "Us" or "Our" in this Agreement)
						refers to Job Locator, United Kingdom.
					</div>
					<div className="mb-1">
					...
					<div className="mb-1">
						<span className="text-lg font-semibold">Country</span> refers to:
						United Kingdom
					</div>
					<div className="mb-1">
						<span className="text-lg font-semibold">Personal Data</span> is any
						information that relates to an identified or identifiable individual
					</div>
					<div className="mb-1">
						<span className="text-lg font-semibold">Service</span> refers to the
					...
					<div className="mb-1">
						<span className="text-lg font-semibold">User Data</span> refers to
					...
					<div className="mb-1">
						<span className="text-lg font-semibold">Website</span> refers to Job
						Locator, accessible from https://ukjoblocator.com/
					</div>
					<div className="">
					...
					<br />
					<h2 className="text-[#17365d] heading-privacy text-2xl font-bold md:whitespace-nowrap">
						Collecting and Using Your Personal Data
					</h2>
					<br />
					<p className="text-[#4f81bd] text-xl font-semibold">
						Types of Data Collected
					</p>
					<br />
					<p className="text-[#4f81bd] text-lg font-semibold">Personal Data</p>
					<br />
					<p className="mb-1">
					...
					<ul className="pl-8">
						...
						<li className="mb-1">Usage Data</li>
					</ul>
					<p className="text-[#4f81bd] font-semibold mb-1">Usage Data</p>
					...
					<h4 className="text-[#4f81bd] text-sm font-semibold mb-1.5">
					...
					<ul className="pl-8">
						<li className="mb-1.5">Information regarding your location</li>
						<li className="mb-1.5">
					...
					<h4 className="text-[#4f81bd] text-sm font-semibold mb-1">
					...
					<ul className="mb-1.5">
						<li className="font-bold mb-1.5">Necessary / Essential Cookies</li>
						<li className="mb-1.5">Type: Session Cookies</li>
						<li className="mb-1.5">Administered by: Us</li>
						<li className="mb-1.5">
						...
						<li className="font-bold mb-1.5">
							Cookies Policy / Notice Acceptance Cookies
						</li>
						<li className="mb-1.5">Type: Persistent Cookies</li>
						<li className="mb-1.5">Administered by: Us</li>
						<li className="mb-1.5">
							Purpose: These Cookies identify if users have accepted the use of
							cookies on the Website.
						</li>
						<li className="font-bold mb-1.5">Functionality Cookies</li>
						<li className="mb-1.5">Type: Persistent Cookies</li>
						<li className="mb-1.5">Administered by: Us</li>
						<li className="mb-1.5">
					...
					<h4 className="text-base text-[#4f81bd] font-bold mb-1.5">
						Use of Your Personal Data
					</h4>
					<p className="mb-1.5">The Company may use Personal Data for the following purposes:</p>
					<p className="mb-1.5">
					...
					<h2 className="text-lg text-[#4f81bd] font-bold">
					...
					<h2 className="text-lg text-[#4f81bd] font-bold mb-1.5">
						Disclosure of Your Personal Data
					</h2>
					<h4 className=" text-[#4f81bd] font-bold">Business Transactions</h4>
					<p className="mb-1.5">
					...
					<h4 className=" text-[#4f81bd] font-bold mb-1.5">Law enforcement</h4>
					<p className="mb-1.5">
					...
					<h4 className=" text-[#4f81bd] font-bold">
					...
					<ul className="list-disc pl-5 mb-1.5">
						<li className="mb-1.5">Comply with a legal obligation</li>
						<li className="mb-1.5">Protect and defend the rights or property of the Company</li>
						<li className="mb-1.5">
						...
						<li className="mb-1.5">Protect against legal liability</li>
					</ul>
					<h2 className="text-lg text-[#4f81bd] font-bold mb-1.5">
					...
					<h2 className="text-[#17365d] heading-privacy text-2xl font-bold whitespace-nowrap mb-1.5">
						Children's Privacy
					</h2>
					<p className="mb-1.5">
