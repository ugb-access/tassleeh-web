		...
		<div>
			...
			<section>
				<div className="relative poster flex flex-col justify-center items-center">
					...
					<p className="text-white text-xl w-3/5 text-center py-4">
					...
					<div>
						<Button
							text="Get Started"
							customClass="bg-primary rounded-2xl p-2 text-sm font-semibold text-white !w-32 !h-16"
						/>
					</div>
				</div>
			</section>
			...
			<div className="flex flex-col justify-center items-center mt-20">
				...
				<h1 className="text-4xl font-bold text-[#0a093d] mt-2 mb-3 ">
			...
			<div className="flex justify-center gap-10 mt-32">
				<div className=" px-5 ">
					...
					<p className="mt-2 mb-2 text-base font-normal leading-8 text-[#656464] w-[500px]">
