...
const CorpPlanCard = ({ onClickButton, plans }) => {
	const [open, setOpen] = useState(false);
	let priceX = plans[2]?.price;
	let planName = plans[2]?.packageName;
	let corporateID = plans[2]?._id;
	...
	return (
		<div className="border-2 border-solid rounded-xl">
			<div className="py-4">
				...
				<div className="mt-6 ml-4 pr-14 whitespace-nowrap">
					...
					<div className="flex items-center gap-2 py-2">
						...
						<p className="text-[#4B5664] text-sm">
							Salary Bench Marketing Advice
						</p>
					</div>
					<div className="flex items-center gap-2 py-2">
						<img src="/images/Path_888.png" alt="" />
						<p className="text-[#4B5664] text-sm">LinkedIn Headhunting</p>
					</div>
					<div className="flex items-center gap-2 py-2">
						<img src="/images/Path_888.png" alt="" />
						<p className="text-[#4B5664] text-sm">
